...
1. Prepare the HM solution.
  ...
  * Preparation is not time consuming, so these reagents can be prepared on the day before use - or can be prepared earlier than this and stored at -20°C (HM solution), room temperature (PBS), or 4°C (PFA) as they are stable.
